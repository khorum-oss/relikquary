...
@SpringBootTest(
    ...
    properties = [
        ...
        "relikquary.security.users[0].username=publisher",
        "relikquary.security.users[0].password={noop}pub-secret",
        "relikquary.security.users[0].roles[0]=PUBLISH",
        "relikquary.security.users[1].username=reader",
        "relikquary.security.users[1].password={noop}read-secret",

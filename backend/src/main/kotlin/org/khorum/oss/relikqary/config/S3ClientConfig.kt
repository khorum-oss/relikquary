...
/**
 * Builds the [S3Client] for the S3 storage backend, created only when `relikqary.storage.backend=s3`.
 ...
 */
@Configuration
@ConditionalOnProperty(name = ["relikqary.storage.backend"], havingValue = "s3")
